// Adapted from quarto-clean-typst by Kazuharu Yanagimoto (MIT License).
...
#let clean-theme(
  ...
  footer: [],
  font-size: 20pt,
  font-family-heading: ("Helvetica Neue"),
  ...
  show: touying-slides.with(
    ...
    config-methods(
      init: (self: none, body) => {
        ...
        set list(
          indent: 1em,
          marker: (move(dy: 0.20em, text(size: 0.7em, fill: self.colors.primary)[ #sym.circle.filled ]),
                    move(dy: 0.20em, text(size: 0.7em, fill: self.colors.primary)[ #sym.circle.filled ])),
        )
        // Ordered List
        set enum(
          indent: 1em,
...
// Custom Functions
#let course-quote(lead, body, attribution: none) = block(
  width: 100%,
  fill: rgb("f4fafc"),
  stroke: (left: 3pt + rgb("4070FF")),
  inset: (left: 1.1em, right: 0.9em, y: 0.65em),
  radius: 4pt,
)[
  #set text(size: 0.72em)
  #set par(leading: 0.55em)
  #text(size: 1.12em, weight: "medium", fill: rgb("4070FF"))[#lead]
  #v(0.4em)
  #body
  #if attribution != none {
    v(0.45em)
    align(right)[
      #text(size: 0.78em, fill: rgb("59636a"))[#attribution]
    ]
  }
]
